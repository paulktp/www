  document.addEventListener("deviceready", onDeviceReady, false);
	...
	var element4 = document.getElementById('site');
	...
	if(device.platform == 'iOS'){
		...
		element4.innerHTML = '<img src="img/facebook.png" onClick = "redirectKyouFB()" style="width: 10%; height:7%; float:right; margin-bottom:3%"/>';
	}else{
