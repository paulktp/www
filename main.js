// Wait for device API libraries to load
	...
	if(device.model.indexOf('iPad') > 0){
			...
			element2.innerHTML += '<p style="text-align:center; font-size:2em">Restaurant de Metz<br />Distance : ' + distMe + 'km ' + device.model.indexOf('iPad') + '<br /><br />Cliquer ici pour plus d\'information</p>';				
		...
		if(parseFloat(distMe) > parseFloat(distTh)){
			...
			element1.innerHTML += '<p style="text-align:center;">Restaurant de Thionville<br />Distance : ' + distTh + 'km ' + device.model.indexOf('iPad') + '<br /><br />Cliquer ici pour plus d\'information</p>';
			...
			element2.innerHTML += '<p style="text-align:center;">Restaurant de Metz<br />Distance : ' + distMe + 'km ' + device.model.indexOf('iPad') + '<br /><br />Cliquer ici pour plus d\'information</p>';				
