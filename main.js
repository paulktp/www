// Wait for device API libraries to load
    ...
    function onSuccess(position) {
		...
		var distMe = Distance(position.coords.latitude , position.coords.longitude, 49.119327,  6.17101);
			...
			element1.innerHTML = '<p style="text-align:center; margin-top:10%;color:e2b500; font-size:1em">Vous êtes plus proche du </p>';
			...
			element2.innerHTML = '<p style="text-align:center; margin-top:15%; font-size:1em">Restaurant de Metz<br />Distance : ' + distMe + 'km <br /><br />Cliquer ici pour plus d\'information</p>';
			element1.style.backgroundColor = "white";
			element2.style.backgroundColor = "white";
		}else{ 
			element2.innerHTML = '<p style="text-align:center; margin-top:10%;color:e2b500; font-size:1em">Vous êtes plus proche du </p>';
			...
			element1.innerHTML = '<p style="text-align:center; margin-top:15%; font-size:1em">Restaurant de Thionville<br />Distance : ' + distTh + 'km <br /><br />Cliquer ici pour plus d\'information</p>';
			element2.style.backgroundColor = "white";
			element1.style.backgroundColor = "white";}
	}
