// Wait for device API libraries to load
	...
	if(device.model.indexOf('iPad') >= 0 || device.model.indexOf('iPod') >= 0){
			...
			element1.innerHTML = '<p style="text-align:center; margin-top:10%;color:e2b500; font-size:10em">Vous êtes plus proche du </p>';
			element1.innerHTML += '<p style="text-align:center; font-size:10em">Restaurant de Thionville<br />Distance : ' + distTh + 'km <br /><br />Cliquer ici pour plus d\'information</p>';
			element2.innerHTML = '<p style="text-align:center; margin-top:15%; font-size:10em">Restaurant de Metz<br />Distance : ' + distMe + 'km <br /><br />Cliquer ici pour plus d\'information</p>';
